...
@Component({
  selector: 'hdb-transfer-form',
  template: `<form #form="ngForm" class="w-[400px]" (ngSubmit)="onSubmitForm(form)">

    <mat-form-field appearance="fill" class="w-full mb-4">
      <mat-label>Concepto</mat-label>
      <input name ="memo"
      matInput type="text"
      placeholder="Ejemplo: Pagar una factura"
      [(ngModel)]="model.memo"
      required
      #memoControl="ngModel"
      />
    ...
    <mat-form-field appearance="fill" class="w-full mb-4">
      ...
      <mat-hint>Debe ser un monto mayor que cero.</mat-hint>
    </mat-form-field>
